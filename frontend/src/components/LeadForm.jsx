...
export default function LeadForm() {
  ...
  const statses = ["New", "Contacted", "Qualified", "Proposal", "Negotiation", "Closed Won", "Closed Lost"];
          ...
          <form className="p-6 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                value={form.source}
                onChange={handleChange}
                className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all ${errors.source ? 'border-red-500 bg-red-50' : 'border-gray-300'
                  }`}
                required
              >
